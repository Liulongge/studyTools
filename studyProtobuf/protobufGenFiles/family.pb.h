...
class Family final :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Person >*
      mutable_person();
  private:
  const ::Person& _internal_person(int index) const;
  ::Person* _internal_add_person();
  public:
...
// repeated .Person person = 1;
inline int Family::_internal_person_size() const {
...
inline const ::Person& Family::_internal_person(int index) const {
...
inline ::Person* Family::_internal_add_person() {
  return _impl_.person_.Add();
}
inline ::Person* Family::add_person() {
  ::Person* _add = _internal_add_person();
